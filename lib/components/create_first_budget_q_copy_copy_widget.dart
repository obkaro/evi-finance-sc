...
class CreateFirstBudgetQCopyCopyWidget extends StatefulWidget {
  const CreateFirstBudgetQCopyCopyWidget({
    Key? key,
    this.budget,
    this.categoryToEdit,
  ...
  @override
  _CreateFirstBudgetQCopyCopyWidgetState createState() =>
      _CreateFirstBudgetQCopyCopyWidgetState();
}
