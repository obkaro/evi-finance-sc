          ...
          body: GestureDetector(
            ...
            child: StreamBuilder<BudgetCategoriesRecord>(
              stream: BudgetCategoriesRecord.getDocument(
                  widget.createdBudget.uncategorizedLink),
              builder: (context, snapshot) {
                // Customize what your widget looks like when it's loading.
                if (!snapshot.hasData) {
                  return Center(
                ...
                final columnBudgetCategoriesRecord = snapshot.data;
                                                    ...
                                                    children: List.generate(
                                                      ...
                                                      final existingCategoriesItem =
                                                          existingCategories[
                                                              existingCategoriesIndex];
                                                      return Visibility(
                                                        visible: (existingCategoriesItem
                                                                .reference) !=
                                                            (columnBudgetCategoriesRecord
                                                                .reference),
                                                        child: Padding(
                                                                      ...
                                                                      return Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          uncategorized:
                                                                              columnBudgetCategoriesRecord,
                                                                          categoriesTotal:
                                                                              functions.sumCategoryAmounts(createBudgetCategoriesBudgetCategoriesRecordList.toList()),
                                                                        ),
                                                                      );
                                                                    },
                                                                  );
                                                              ...
                                                              FlutterFlowIconButton(
                                                                ...
                                                                onPressed:
                                                                  ...
                                                                  final budgetCategoriesUpdateData =
                                                                    ...
                                                                    'allocatedAmount':
                                                                        FieldValue.increment(
                                                                            existingCategoriesItem.allocatedAmount),
                                                                  };
                                                                  await columnBudgetCategoriesRecord
                                                                      .reference
                                                                      .update(
