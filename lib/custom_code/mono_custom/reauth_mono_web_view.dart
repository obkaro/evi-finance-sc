...
import 'mono_reauth_html.dart';

class ReauthMonoWebView extends StatefulWidget {
  ...
  @override
  _ReauthMonoWebViewState createState() => _ReauthMonoWebViewState();
}

class _ReauthMonoWebViewState extends State<ReauthMonoWebView> {
