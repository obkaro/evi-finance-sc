...
class _$ConstInstitutionLogosRecord extends ConstInstitutionLogosRecord {
  ...
  factory _$ConstInstitutionLogosRecord(
      ...
      (new ConstInstitutionLogosRecordBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ConstInstitutionLogosRecord')
...
class ConstInstitutionLogosRecordBuilder
  ...
  @override
  ConstInstitutionLogosRecord build() => _build();

  _$ConstInstitutionLogosRecord _build() {
    final _$result = _$v ??
