  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      final transactionsCreateData = createTransactionsRecordData(
        account: addTransactionAccountsRecord.reference,
      );
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<AccountsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AccountsRecord> addTransactionAccountsRecordList = snapshot.data;
        // Return an empty Container when the document does not exist.
        if (snapshot.data.isEmpty) {
          return Container();
        }
        final addTransactionAccountsRecord =
            addTransactionAccountsRecordList.isNotEmpty
                ? addTransactionAccountsRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
                                ...
                                child: FutureBuilder<List<AccountsRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return GridView.builder(
                                      ...
                                      itemCount:
                                          gridViewAccountsRecordList.length,
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: FlutterFlowChoiceChips(
                                  ...
                                  options: [
                                    ChipData(
                                        'Credit', Icons.add_circle_outlined),
                                    ChipData(
                                        'Debit', Icons.do_disturb_on_rounded)
                                  ],
