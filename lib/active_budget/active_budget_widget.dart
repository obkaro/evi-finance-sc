    ...
    return AuthUserStreamWidget(
      child: StreamBuilder<List<BudgetCategoriesRecord>>(
        ...
        builder: (context, snapshot) {
          ...
          List<BudgetCategoriesRecord> activeBudgetBudgetCategoriesRecordList =
              snapshot.data;
          return Scaffold(
            key: scaffoldKey,
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Stack(
                                        ...
                                        children: [
                                          if ((activeBudgetBudgetCategoriesRecordList
                                                  .length) >
                                              0)
                                            Row(
                                              mainAxisSize: MainAxisSize.max,
                                                    ...
                                                    stream:
                                                      ...
                                                      queryBuilder: (transactionsRecord) =>
                                                          transactionsRecord.where(
                                                              'linkedCategory',
                                                              whereIn: activeBudgetBudgetCategoriesRecordList
                                                                  .map((e) => e
                                                                      .reference)
                                                                  .toList()),
                                                    ),
                                        ...
                                        child: CreateCustomCategoryWidget(
                                          ...
                                          budgetRemaining:
                                              functions.calculateRemBudgetCat(
                                                  activeBudgetBudgetCategoriesRecordList
                                                      .toList(),
